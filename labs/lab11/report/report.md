...
С помощью комбинации Ctrl-x Ctrl-f, создала файл lab11.sh:

![Созданный файл](image/3.png){#fig:003 width=70%}

Я написала некоторый текст в этом же файле (lab11.sh). После этого сохранила файл с помощью комбинации Ctrl-x Ctrl-s:
